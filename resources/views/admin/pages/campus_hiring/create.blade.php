...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Tambah Data Campus Hiring</h1>

        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin.campus-hiring.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('kategori') is-invalid @enderror" id="kategori"
                                    ...
                                    <option value="Offline" {{ old('kategori', 'Offline') == 'Offline' ? 'selected' : '' }}>
                                        Offline</option>
                                </select>
                                @error('kategori')
                                    <div class="invalid-feedback">{{ $message }}</div>
