...
<div class="sidebar d-flex flex-column p-3" id="sidebar">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="{{ route('admin.bimbingan-karir.index') }}" class="nav-link text-white menu-item">
                <i class="bi bi-camera-video"></i> Bimbingan karir
            </a>
        </li>
        <li>
            <a href="{{ route('admin.campus-hiring.index') }}" class="nav-link text-white menu-item">
                <i class="bi bi-camera-video"></i> Campus Hiring
            </a>
        </li>
    </ul>
    <hr class="text-white">
