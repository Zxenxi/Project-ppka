...
@section('title', 'Campus Hiring - PPKA')
    ...
    <section class="section-events">
        <div class="container">
            <div class="section-header text-center">
                <h1 class="title">Campus Hiring</h1>
                <p class="subtitle">Jalin koneksi langsung dengan perusahaan terkemuka di acara rekrutmen kampus kami.</p>
            </div>

            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 justify-content-center">
                {{-- CORRECTED: Using the correct $campusHirings variable from the controller --}}
                @forelse($campusHirings as $item)
                    <div class="col">
                        <article class="event-card" role="button" data-bs-toggle="modal"
                            data-bs-target="#modalCampusHiring{{ $item->id }}">
                    ...
                    <div class="modal fade modal-fullscreen" id="modalCampusHiring{{ $item->id }}" tabindex="-1"
                        aria-hidden="true">
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center p-5 bg-light rounded">
                            <p class="h5">Belum ada agenda campus hiring</p>
